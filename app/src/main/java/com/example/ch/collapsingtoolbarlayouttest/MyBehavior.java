    ...
    private void recovery(final AppBarLayout abl) {
        if (mTotalDy > 0) {
            ...
            if (isAnimate) {
                ...
                ValueAnimator anim = ValueAnimator.ofFloat(mLastBottom, mParentHeight).setDuration(200);
                ...
                if (mLastScale > 1f) {
                    ...
                    animSet.play(translationY).with(scaleY).with(scaleX).with(anim);
                    animSet.setDuration(200);
                } else {
                    animSet.play(translationY).with(anim);
                    animSet.setDuration(200);
                }
